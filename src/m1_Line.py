...
class Line(object):
    ...
    def length(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        return (math.sqrt((self.end.y-self.start.y)**2+(self.start.x-self.end.x)**2))
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        return(Line(Point(self.start.x+other_line.start.x,other_line.start.y+self.start.y),
    ...
    def is_parallel(self, line2):
        ...
        #######################################################################
        a=math.sqrt((self.start.x-line2.start.x)**2+(self.start.y-line2.start.y)**2)
        b=math.sqrt((self.end.x-line2.end.x)**2+(self.end.y-line2.end.y)**2)
